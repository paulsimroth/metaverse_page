  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <motion.p
        ...
        className="mt-[8px] font-normal sm:text-[32px] tex-[20px] text-center text-secondary-white"
      >
        <span className="font-extrabold text-white">Metaverse</span> is a new thing of the future, where you can enjoy the virtual world by feeling like it's really real,
